        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.categories','main_category')}}"
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Category::child() -> count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.categories','child_category')}}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin/sidebar.show_all')}}</a>
                    </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.tags.create')}}" data-i18n="nav.dash.crypto">{{__('admin/sidebar.tags-add')}}</a>
                    </li>
                </ul>
            </li>
